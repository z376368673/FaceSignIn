...
import com.baidu.idl.face.platform.ui.face.CameraImageSource;
import com.baidu.idl.face.platform.ui.face.DetectRegionProcessor;
import com.baidu.idl.face.platform.ui.face.FaceDetectManager;
import com.baidu.idl.face.platform.ui.face.FaceFilter;
import com.baidu.idl.face.platform.ui.face.ImageFrame;
import com.baidu.idl.face.platform.ui.face.PreviewView;
import com.baidu.idl.face.platform.ui.face.camera.ICameraControl;
import com.baidu.idl.face.platform.ui.face.camera.PermissionCallback;
import com.baidu.idl.facesdk.FaceInfo;
import com.hzhl.facecheck.R;
import com.hzhl.facecheck.model.UserInfo;
import com.hzhl.facecheck.net.APIServices;
import com.hzhl.facecheck.net.Http;
import com.hzhl.facecheck.utils.ImageSaveUtil;
import com.hzhl.facecheck.utils.ImageUtil;
import com.hzhl.facecheck.widget.BrightnessTools;
import com.hzhl.facecheck.widget.FaceRoundView;
import com.hzhl.facecheck.widget.WaveHelper;
import com.hzhl.facecheck.widget.WaveView;
...
public class FaceScanLongActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        cameraImageSource.getCameraControl().setPermissionCallback(new PermissionCallback() {
            ...
            public boolean onRequestPermission() {
                ActivityCompat.requestPermissions(FaceScanLongActivity.this,
...
//                Color.parseColor("#3cf16d7a"));
    ...
    private void initBrightness() {
        int brightness = BrightnessTools.getScreenBrightness(FaceScanLongActivity.this);
        if (brightness < 200) {
    ...
    private void upload(FaceFilter.TrackedModel model) {
        ...
        if (model.getEvent() != FaceFilter.Event.OnLeave) {
            try {
                ...
                ImageSaveUtil.saveCameraBitmap(FaceScanLongActivity.this, face, "head_tmp.jpg");
                APIServices.getInstance().userLogin(file, new Http.JsonCallback() {
                    @Override
                    public void onResult(String json, String error) {
                        ...
                        if (code==1){
                            UserInfo.setUserInfo(jsonObject.getString("data"));
                            Toast.makeText(FaceScanLongActivity.this,json,Toast.LENGTH_SHORT).show();
                            starAct(SignInActivity.class);
                            finish();
                        }
                    }
                    ...
                    public void onFail(String error) {
                        deleteFace(file);
                       // mUploading = false;
                        Toast.makeText(FaceScanLongActivity.this,error,Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            } catch (IOException e) {
    ...
    private static class InnerHandler extends Handler {
        private WeakReference<FaceScanLongActivity> mWeakReference;

        public InnerHandler(FaceScanLongActivity activity) {
            super();
            this.mWeakReference = new WeakReference<FaceScanLongActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            FaceScanLongActivity activity = mWeakReference.get();
            if (activity == null) {
                return;
            }
            if (msg == null) {
